...
const beutel_amount = document.querySelector(".shopping.beutel_value");
const beutel_btn = document.querySelector(".addBtn.beutel");
const beutel_price = document.querySelector(".priceValue_ja_05");

const mullbeutel_amount = document.querySelector(".shopping.mullbeutel_value");
const mullbeutel_btn = document.querySelector(".addBtn.mullbeutel");
const mullbeutel_price = document.querySelector(".priceValue_purio");
...
const beutel_ID = "beutel";
const mullbeutel_ID = "mullbeutel";
...
beutel_price.innerText = beutel + "€";
mullbeutel_price.innerText = mullbeutel + "€";
...
beutel_btn.onclick = function() {
    add_Item(beutel_amount, beutel, beutel_ID);
}
beutel_amount.onclick = function() {
    remove_Item(beutel_amount, beutel, beutel_ID);
}
mullbeutel_btn.onclick = function() {
    add_Item(mullbeutel_amount, mullbeutel, mullbeutel_ID);
}
mullbeutel_amount.onclick = function() {
    remove_Item(mullbeutel_amount, mullbeutel, mullbeutel_ID);
}
